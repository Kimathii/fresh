...
// 
...

  {
    ...
    products: [
      { name: "C4 Sport Pre-Workout Powder, Hawaiian Punch, 20 servings", price: 18.74 },
      { name: "C4 Sport Pre-Workout Powder, Icy Blue Razz, 20 servings", price: 18.74 },
      { name: "C4 Sport Ripped Pre-Workout Powder, Jolly Rancher Cherry, 20 servings", price: 25.48 },
      { name: "C4 Sport Ripped Pre-Workout Powder, Strawberry Watermelon, 20 servings", price: 25.48 },
      { name: "C4 Whey Protein Powder, Hershey’s Milk Chocolate, 18 servings", price: 19.98 },
      { name: "C4 Whey Protein Powder, Reese’s Peanut Butter Cup, 18 servings", price: 19.98 },
      { name: "Xtend BCAA Powder, Watermelon Explosion, 30 servings", price: 24.97 },
      { name: "Xtend BCAA Powder, Blue Raspberry Ice, 30 servings", price: 24.97 },
      { name: "Xtend BCAA Powder, Airheads Cherry, 30 servings", price: 24.97 }
    ]
  },
